...
### Added
- [jsonl] JSON Lines / NDJSON (`.jsonl`, `.ndjson`, `.jsonlines`, `.ldjson`)
- [far2lmenu] far2l user-menu command: bash/sh with far2l meta-symbols (`Far2lUserMenu.bash`, `.far2lmenu`)
- [far2lusermenu] far2l `user_menu.ini` (`CommandN` as far2lmenu)
